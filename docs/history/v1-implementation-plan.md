...
> Archived on 2026-07-16 from source commit `93da974`. This is the original V1 implementation snapshot. Checkbox and status values are preserved as historical state, not current capability claims. Current behavior is documented in the root [README](../../README.md) and the maintained [documentation guides](../README.md).
